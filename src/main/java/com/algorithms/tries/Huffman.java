...
public class Huffman {
    ...
    // compress bytes from standard input and write to standard output.txt
...
//        String s = ;
    ...
    // write bitstring-encoded trie to standard output.txt
...
//            System.out.print(st[x.ch]+"t");
    ...
    // expand Huffman-encoded input from standard input and write to standard output.txt
