 ...
 * The output.txt nodes can be printed in any order. Expected time complexity is O(n)
 * <p>
 * A node x is there in output.txt if x is the topmost node at its horizontal distance. Horizontal distance of left child of a node x is equal
